...
{
	CTFProjectile_Flare *pFlare = static_cast<CTFProjectile_Flare *>( CTFBaseRocket::Create( pWeapon, "tf_projectile_flare", vecOrigin, vecAngles, pOwner, TF_PROJECTILE_FLARE ) );
