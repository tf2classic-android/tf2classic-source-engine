...
// HARDCODED WEAPON SPREAD TABLE
extern const Vector g_vecFixedWpnSpreadPellets[];
extern const Vector g_vecFixedSuperShotgunSpread[];
...
enum ProjectileType_t
{
	...
	TF_PROJECTILE_NAIL,
	TF_PROJECTILE_DART,
	TF_PROJECTILE_SUPERNAIL,
	TF_PROJECTILE_MIRV,
	TF_PROJECTILE_PLASMA,
	TF_PROJECTILE_CROSSBOW_BOLT,
	TF_PROJECTILE_ROCKET_CLASSIC,
	TF_PROJECTILE_PIPEBOMB_CLASSIC,
...
enum ETFCond
{
	...
	TF_COND_PURGATORY, // UNUSED
	TF_COND_SLOWED, // TF_COND_TRANQUILIZED
	TF_COND_AIRBLASTED,
	TF_COND_INVULNERABLE_SPAWN_PROTECT,
	TF_COND_INVULNERABLE_CHAT_PROTECTION,
	TF_COND_LASTSTANDING,
	TF_COND_CHARGING_POUNCE, // UNUSED
	TF_COND_SOFTZOOM,
	...
	TF_COND_SWIMMING_NO_EFFECTS,
	TF_COND_PURGATORY,
	TF_COND_TRANQUILIZED, // Should be TF_COND_SLOWED
	TF_COND_AIRBLASTED,
	TF_COND_INVULNERABLE_SPAWN_PROTECT,
	TF_COND_INVULNERABLE_CHAT_PROTECTION,
	TF_COND_LASTSTANDING,
	TF_COND_CHARGING_POUNCE,
	TF_COND_SOFTZOOM,
