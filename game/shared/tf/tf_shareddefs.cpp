...
const char *g_aWeaponNames[] =
{
	...
	"TF_WEAPON_CHAINSAW",
	"TF_WEAPON_HEAVYARTILLERY", // (TF_WEAPON_TOMMYGUN) TF_WEAPON_HEAVYARTILLERY is gone
	"TF_WEAPON_ASSAULTRIFLE",
	"TF_WEAPON_DISPLACER",
	"TF_WEAPON_DISPLACER_BOMB",
	//"TF_WEAPON_CHAINGUN",
	//"TF_WEAPON_LEVERRIFLE",
	//"TF_WEAPON_SUPERNAILGUN",
	//"TF_WEAPON_HUNTINGSHOTGUN",
	//"TF_WEAPON_CLAWS",
...
int g_aWeaponDamageTypes[] =
{
	...
	DMG_GENERIC,	// TF_WEAPON_FLAG // TODO(SanyaSho): FLAG CHANGED TO 128 (DMG_CLUB)
	DMG_IGNITE,		// TF_WEAPON_FLAREGUN,
	DMG_GENERIC,	// TF_WEAPON_LUNCHBOX,
	DMG_BULLET,		// TF_WEAPON_COMPOUND_BOW

	// Nov 3 2017
	// TF_WEAPON_SHOTGUN_BUILDING_RESCUE	2097154			// DMG_BULLET | DMG_USEDISTANCEMOD
	// TF_WEAPON_HUNTERRIFLE				33554434		// DMG_BULLET | DMG_USE_HITLOCATIONS
	// TF_WEAPON_COILGUN					2050			// DMG_BULLET | DMG_PREVENT_PHYSICS_FORCE
	// TF_WEAPON_UMBRELLA					128				// DMG_CLUB
	// TF_WEAPON_CUBEMAP					0				// DMG_GENERIC
	// TF_WEAPON_HAMMERFISTS				8320			// DMG_CLUB | DMG_ALWAYSGIB
	// TF_WEAPON_SHOTGUN_MERC				538968066		// DMG_BULLET | DMG_BUCKSHOT | DMG_USEDISTANCEMOD
	// TF_WEAPON_PISTOL_MERC				2097154			// DMG_BULLET | DMG_USEDISTANCEMOD
	// TF_WEAPON_ROCKETLAUNCHER_MERC		2098240			//
	// TF_WEAPON_GRENADELAUNCHER_MERC		1088			//
	// TF_WEAPON_SUPERSHOTGUN				538968066		// DMG_BULLET | DMG_BUCKSHOT | DMG_USEDISTANCEMOD
	// TF_WEAPON_STENGUN					2097154			// DMG_BULLET | DMG_USEDISTANCEMOD
	// TF_WEAPON_SIXSHOOTER					2097154			// DMG_BULLET | DMG_USEDISTANCEMOD
	// TF_WEAPON_CHAINSAW					8196			// DMG_ALWAYSGIB
	// TF_WEAPON_TOMMYGUN					2097154			// DMG_BULLET | DMG_USEDISTANCEMOD
	// TF_WEAPON_ASSAULTRIFLE				2097154			// DMG_BULLET | DMG_USEDISTANCEMOD
	// TF_WEAPON_DISPLACER					2359360			// DMG_BLAST | DMG_HALF_FALLOFF | DMG_USEDISTANCEMOD
	// TF_WEAPON_DISPLACER_BOMB				262208			//
	// TF_WEAPON_CHAINGUN					2097154			// DMG_BULLET | DMG_USEDISTANCEMOD
	// TF_WEAPON_LEVERRIFLE					33554434		// DMG_BULLET | DMG_USE_HITLOCATIONS
	// TF_WEAPON_SUPERNAILGUN				2230274			// DMG_BULLET | DMG_USEDISTANCEMOD | DMG_NOCLOSEDISTANCEMOD | DMG_PREVENT_PHYSICS_FORCE
	// TF_WEAPON_HUNTINGSHOTGUN				538968066		// DMG_BULLET | DMG_BUCKSHOT | DMG_USEDISTANCEMOD
	// TF_WEAPON_CLAWS 						4				// DMG_SLASH
	...
	DMG_BULLET | DMG_USEDISTANCEMOD, // TF_WEAPON_HEAVYARTILLERY, // (TF_WEAPON_TOMMYGUN) TF_WEAPON_HEAVYARTILLERY is gone
