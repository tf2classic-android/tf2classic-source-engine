...
private:
	...
	// tyabus: VS2013 gives C2536 error
#if ( _MSC_VER ) <= 1800
	int m_nChunkSize[kChunkCount];
#else
...
void* CreateMiniMP3Codec()
{
	CVAudioMiniMP3* s_pVAudio = new CVAudioMiniMP3;

	return s_pVAudio;
}

EXPOSE_INTERFACE_FN( CreateMiniMP3Codec, IVAudio, VAUDIO_INTERFACE_VERSION );
